    ...
    return (
        <Container maxWidth="lg">
            <Box sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', textAlign: 'center' }}>
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: '30px', margin: '100px 0 50px' }}>
                    <Typography variant="h1" sx={{ position: 'relative', maxWidth: '730px', lineHeight: '130%' }}>
                        Discover Furniture With High Quality Wood
                        <SvgIcon sx={{ position: 'absolute', top: '71px', left: '-210px' }} style={{ width: '327', height: '327' }}>
                        ...
                        <SvgIcon sx={{ position: 'absolute', bottom: '35px', right: '15px' }} style={{ width: '51', height: '51' }}>
                ...
                <Box width="100%" sx={{ position: 'relative' }}>
                    ...
                    />
                    <Box component="img" src="/rectangle.png" maxWidth="lg" sx={{ position: 'absolute', width: 'auto', top: '35px', left: '0', zIndex: '-1' }}></Box>
                </Box>
            </Box>
        </Container>
    );
